...
import WeeklyTechnicalCalendar from "../components/DHG/POS/WeeklyTechnicalCalendar";
...
const DHGRoutes = [
  ...
  { path: "/profile", element: <PrivateRoutes element={<Profile />} /> },
  { path: "/settings", element: <PrivateRoutes element={<Settings />} /> },
  { path: "/cvpos/lichpos", element: <PrivateRoutes element={<WeeklyTechnicalCalendar />} /> },
];
