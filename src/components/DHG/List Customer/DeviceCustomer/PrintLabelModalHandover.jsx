...
const PrintLabelModalHandover = ({ visible, onClose, deviceData }) => {
    ...
    return (
        ...
        >
            <div style={{ fontFamily: "Arial, sans-serif", padding: "10px" }}>
                ...
                <p style={rowStyle}>
                    <span style={labelStyle}><CalendarOutlined /> Ngày bàn giao:</span> <span>{formattedCreatedAt}</span>
                </p>
...
export default PrintLabelModalHandover;