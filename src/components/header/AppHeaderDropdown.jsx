  ...
  return (
    <Nav>
      ...
      >
        ...
        <NavDropdown.Item onClick={() => navigate('/dhg/profile')}>Hồ sơ cá nhân</NavDropdown.Item>
        <NavDropdown.Item onClick={() => navigate('/dhg/settings')}>Cài đặt hệ thống</NavDropdown.Item>
        <NavDropdown.Divider />
